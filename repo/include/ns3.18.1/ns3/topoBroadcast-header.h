...
#ifndef TOPBROADCASTCAST_HEADER_H
#define TOPBROADCASTCAST_HEADER_H
 ...
 * \ingroup geoRouting
 *
 * \brief  iTETRIS [WP600] - topoBroadcast header
 */

class topoBroadcastHeader : public Header
{
public:
...
#endif   /*TOPBROADCASTCAST_HEADER_H*/

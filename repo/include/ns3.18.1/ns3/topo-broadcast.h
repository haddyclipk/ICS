...
#ifndef TOPOBROADCAST_H_
#define TOPOBROADCAST_H_
 ...
 * \ingroup topoRouting
 *
 * \brief  iTETRIS [WP600] - topoBroadcast routing protocol
 */
class topoBroadcast : public c2cRoutingProtocol
{
public:
  static TypeId GetTypeId (void);

  topoBroadcast ();
  virtual ~topoBroadcast();

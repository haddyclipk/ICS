...
// iTetris INTECS
  ...
  bool IsiTetrisNode (void); // Added by Intecs
// iTetris INTECS

  uint64_t GetCountBytes (void); // Added by Eva 3.3
  void SetCountBytes (uint64_t ui64Bytes); // Added by Eva 3.3
...
// iTetris INTECS
  ...
  bool m_isiTetrisNode; // Added by Azzarelli
  uint64_t m_ui64ContBytes; // Added by Eva 3.3
// iTetris INTECS
};

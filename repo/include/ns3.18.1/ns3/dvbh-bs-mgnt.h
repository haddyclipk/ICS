...
#ifndef DVBH_BS_MGNT_H
#define DVBH_BS_MGNT_H
...
{
/**
 * The base class DvbhBsMgnt implements the IpBaseStaMgnfor the technology UMTS
 */
class DvbhBsMgnt : public IpBaseStaMgnt
{
  public:

...
#ifndef VISIBILITY_PROB_C2_MODEL_H
#define VISIBILITY_PROB_C2_MODEL_H
...
class VisibilityProbC2 : public VisibilityModel
{
public:
  static TypeId GetTypeId (void);
  VisibilityProbC2 (void);
  ~VisibilityProbC2 ();
...
#endif /* VISIBILITY_PROB_C2_MODEL_H */

...
#ifndef GEOBROADCAST_H_
#define GEOBROADCAST_H_
 ...
 * \ingroup geoRouting
 *
 * \brief geoBroadcast routing protocol
 */
class geoBroadcast : public c2cRoutingProtocol
{
public:
  static TypeId GetTypeId (void);
  geoBroadcast ();
  virtual ~geoBroadcast();
  ...
  bool checkReception (Ptr<const Packet> p, const c2cCommonHeader &commonHeader);
...
private:
 ...
 // bool checkReception(Ptr<const Packet> p);
};

}

#endif /* GEOBROADCAST_H_ */

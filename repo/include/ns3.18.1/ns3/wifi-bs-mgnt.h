...
#ifndef WIFI_BS_MGNT_H
#define WIFI_BS_MGNT_H
...
/**
 * @class WifiBsMgnt
 * @brief The base class WifiBsMgnt implements the IpBaseStaMgnfor the technology WiFi
 */
class WifiBsMgnt : public IpBaseStaMgnt
{
  public:

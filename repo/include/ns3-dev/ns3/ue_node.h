...
public:
  ...
  */
  ...
  void SetDelay(Ptr<Packet> receivedPacket);

  //Gets the number of bytes for interface
  void GetNBytesForInterface(totDataInterface& bytesTotal);

  //Returns the bundle delay/jitter
  DelayJitterSample GetDelay();

  //Gets the  m_bInject value
  bool GetInjectMode();
...
private:
  ...
  //DelayJitterSample
  DelayJitterSample m_delayJitterTrace;
};

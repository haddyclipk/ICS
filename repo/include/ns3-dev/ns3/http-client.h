/* -*- Mode:C++; c-file-style:"gnu"; indent-tabs-mode:nil; -*- */ 
 ...
 public: 
   ...
   /** 
    * \brief Call the time out function and time out the ongoing web page and rec
ord the results 
 ...
 /** 
  * \brief Generate the Adu containers, either with Internet mode or transactionmode. 
  * 
 ...
 private: 
   ...
   Address               m_local;                        ///< Address where thisHttpClient application is running. 

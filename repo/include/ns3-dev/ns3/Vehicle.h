...
namespace ns3 {
     ...
     * A Vehicle can have direction which is specified as radians from the positive x axis.
    ...
    private:
        ...
        double m_direction; // vehicle's direction.
        int m_typeId; // vehicle's type id
        ...
        std::list<int> destinations; // vehicle has a list of highway IDs that it wants to get to (final destinations)
    ...
    public:
        ...
        double GetDirection();
        /**
         * \param value the direction of the Vehicle. Direction is specified in radians from the positive x axis.
         */

/* -*- Mode:C++; c-file-style:"gnu"; indent-tabs-mode:nil; -*- */ 
  ...
  * 
  * Each ADU represents data to be sent over the network by either the client or 
the 
 ...
 { 
   ...
   /** 
    * The page number of the ADU.  NOTE: the page number is useful for recording 
the page delivery time as 
